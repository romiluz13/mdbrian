...
Security fixes are provided for the latest released `@mdbrain/*` package
...
Use [GitHub private vulnerability reporting](https://github.com/romiluz13/mdbrain/security/advisories/new)

...
function resolveVoyageBatchDeps(
	overrides: Partial<VoyageBatchDeps> | undefined,
): VoyageBatchDeps {
	return {
		...
		uploadBatchJsonlFile:
			overrides?.uploadBatchJsonlFile ?? uploadBatchJsonlFile,
		withRemoteHttpResponse:
			overrides?.withRemoteHttpResponse ?? withRemoteHttpResponse,
	}
}

---
title: Quickstart
description: Start Mbrain, add one memory, and search it.
icon: "play"
---
...
Mbrain can be used directly by apps or exposed to agents as a Company Brain.
...
```bash
cd apps/web
MBRAIN_API_URL=http://127.0.0.1:3847 bun run dev
```
...
<CardGroup cols={2}>
  <Card title="Memory Concepts" icon="brain" href="/concepts/memory">
    Learn how Mbrain stores and retrieves memory.
  </Card>

---
title: Quickstart
description: Start Mdbrian, add one memory, and search it.
icon: "play"
---
...
Mdbrian can be used directly by apps or exposed to agents as a Company Brain.
...
<CardGroup cols={2}>
  <Card title="Memory Concepts" icon="brain" href="/concepts/memory">
    Learn how Mdbrian stores and retrieves memory.
  </Card>

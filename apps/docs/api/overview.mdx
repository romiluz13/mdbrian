---
title: API Overview
description: Mdbrian HTTP API endpoint reference.
icon: "unplug"
---

The Mdbrian API server runs at `http://127.0.0.1:3847` by default (via `apps/api`).

The API is the app-facing surface of the Mdbrian Company Brain framework. It can
